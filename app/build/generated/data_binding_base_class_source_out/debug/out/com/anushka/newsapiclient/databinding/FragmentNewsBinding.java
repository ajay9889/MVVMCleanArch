...
public final class FragmentNewsBinding implements ViewBinding {
  ...
  private FragmentNewsBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static FragmentNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvNews;
      RecyclerView rvNews = rootView.findViewById(id);
      if (rvNews == null) {
        break missingId;
      }

      return new FragmentNewsBinding((LinearLayout) rootView, progressBar, rvNews);
    }
